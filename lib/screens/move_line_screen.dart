...
class MoveLineScreen extends StatefulWidget {
  final VoidCallback onBackToMenu;

  const MoveLineScreen({super.key, required this.onBackToMenu});

  @override
  State<MoveLineScreen> createState() => _MoveLineScreenState();
}

class _MoveLineScreenState extends State<MoveLineScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final stats = [
      {'icon': Icons.check_circle_outline_rounded, 'label': 'IR Array', 'value': 'Calibrated', 'color': CyberTheme.emerald},
      {'icon': Icons.memory_rounded, 'label': 'Control Loop', 'value': 'Real-Time Adjust', 'color': CyberTheme.violet},
      {'icon': Icons.shield_rounded, 'label': 'Safety', 'value': 'System Ready', 'color': const Color(0xFF60A5FA)},
      {'icon': Icons.alt_route_rounded, 'label': 'Navigation', 'value': 'Line Tracking', 'color': const Color(0xFF818CF8)},
    ];
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                decoration: CyberTheme.glassCardDecoration(
                  borderColor: CyberTheme.violet.withOpacity(0.35),
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: CyberTheme.violet.withOpacity(0.12),
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(color: CyberTheme.violet.withOpacity(0.3)),
                          ),
                          child: const Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(Icons.auto_awesome_rounded, color: CyberTheme.violet, size: 12),
                              SizedBox(width: 4),
                              Text(
                                'LINE TRACKER ACTIVE',
                                style: TextStyle(
                    ...
                    const Text(
                      'Your Smart Chassis is executing Move in Line Chassis Mode. High-precision IR optical sensors track floor paths in real-time, computing adaptive micro-steering for precise centerline navigation.',
                      style: TextStyle(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: CyberTheme.violet.withOpacity(0.25)),
                      ),
                      child: Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: CyberTheme.glowShadow(CyberTheme.violet, blur: 10, opacity: 0.8),
                            ),
                          ),
                          ...
                          const Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'IR Optical Array Active',
                                  style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w800),
                                  overflow: TextOverflow.ellipsis,
                                ),
                                Text(
                                  'Dual sensor centerline alignment active',
